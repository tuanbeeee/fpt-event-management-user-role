                                ...
                                <div class="shop-product-wrap grids row justify-content-center">
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="product-item">
                                            <div>                                             
                                                <a href="MainController?action=ClubInfo&CLUB_ID=<%=clb.getOrgID()%>&USER_ID=<%=user.getId()%>&ORG_ID=<%=clb.getOrgID()%>">
                                                    <%if (clb.getImgUrl().contains("Image")) {%>
                                                    <img src="http://localhost:8080/event-management/<%=clb.getImgUrl()%>" alt="shope">
                                                    <%} else {%>
                                                    <img src="<%=clb.getImgUrl()%>" alt="shope">
                                                    <%}%>
                                                </a>                                       
                                            </div>
